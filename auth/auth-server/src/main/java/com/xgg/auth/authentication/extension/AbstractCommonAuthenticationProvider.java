...
import com.xgg.auth.authentication.extension.smsauthentication.SmsAuthenticationToken;
 ...
 * @author renchengwei
 * @date 2019-11-16
 * 通用用户授权提供者，参考了AbstractUserDetailsAuthenticationProvider，去掉对UsernamePasswordAuthenticationToken
 * 的依赖，可以由子类扩展
 */
public abstract class AbstractCommonAuthenticationProvider implements
    ...
    private UserDetailsChecker preAuthenticationChecks = new AbstractCommonAuthenticationProvider.DefaultPreAuthenticationChecks();
    private UserDetailsChecker postAuthenticationChecks = new AbstractCommonAuthenticationProvider.DefaultPostAuthenticationChecks();
    ...
    public Authentication authenticate(Authentication authentication)
        ...
        Assert.isInstanceOf(SmsAuthenticationToken.class, authentication,
                () -> messages.getMessage(
                        "AbstractCommonAuthenticationProvider.onlySupports",
     ...
     * {@link #additionalAuthenticationChecks(UserDetails, SmsAuthenticationToken)}
